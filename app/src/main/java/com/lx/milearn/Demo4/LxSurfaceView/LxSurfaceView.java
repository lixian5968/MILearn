package com.lx.milearn.Demo4.LxSurfaceView;
 ...
 */
public class LxSurfaceView extends SurfaceView  implements Runnable, SurfaceHolder.Callback {
    ...
    protected void Draw() {
        ...
        if (mCanvas != null) {
            ...
            Bitmap pic = ((BitmapDrawable) getResources().getDrawable(
                    R.drawable.ic_keyboard_grey_500_36dp)).getBitmap();
