...
import com.lx.milearn.Demo3.file.AttachmentStore;
...
public class VideoActivityDemo extends AppCompatActivity implements SurfaceHolder.Callback {
...
//        }
    ...
    private void tooShortAlert() {
        ...
        builder.setTitle(getString(R.string.video_record_short));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_activity_demo);


        filename ="/storage/emulated/0/com.netease.nim.demo/temp/81ec92ee-e92c-4ddd-9132-2201530e222c.mp4";
